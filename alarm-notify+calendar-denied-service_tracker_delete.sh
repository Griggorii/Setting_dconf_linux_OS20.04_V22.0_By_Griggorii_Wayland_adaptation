...
EOF
x-www-browser github.com/Griggorii/Setting_dconf_linux_OS20.04_V25.0_By_Griggorii_Wayland_adaptation
EOF
chromium-browser github.com/Griggorii/Setting_dconf_linux_OS20.04_V25.0_By_Griggorii_Wayland_adaptation
EOF
