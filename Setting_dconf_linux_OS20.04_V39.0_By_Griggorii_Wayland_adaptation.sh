...
disabled-extensions=['dash-to-panel@jderose9.github.com', 'appindicatorsupport@rgcjonas.gmail.com', 'pop-shell@system76.com', 'dash-to-dock@micxgx.gmail.com', 'unite@hardpixel.eu', 'arcmenu@arcmenu.com', 'ding@rastersoft.com', 'desktop-icons@csoriano']
enable-hot-corners=true
