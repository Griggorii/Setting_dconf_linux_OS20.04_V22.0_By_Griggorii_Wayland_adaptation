...
last-used-preset='Akai HD-230_V14'
...
active-plugins=['snippets', 'time', 'quickhighlight', 'externaltools', 'docinfo', 'spell', 'quickopen', 'filebrowser', 'modelines', 'pythonconsole']
...
system-theme-associations={'HighContrast': 'HighContrast', 'HighContrastInverse': 'HighContrastInverse', 'LowContrast': 'LowContrast', 'ContrastHighInverse': 'HighContrastInverse', 'Default': '', 'Pop-dark-slim': '', 'Pop-dark': ''}
