...
active-plugins=['snippets', 'filebrowser', 'docinfo', 'quickhighlight', 'time', 'pythonconsole', 'modelines', 'externaltools', 'spell', 'quickopen']
...
disabled-extensions=['compiz-alike-magic-lamp-effect@hermes83.github.com']
enable-hot-corners=true
...
EOF
x-www-browser www.github.com/Griggorii/Setting_dconf_linux_OS20.04_V28.0_By_Griggorii_Wayland_adaptation
EOF
killall plank
EOF
plank
