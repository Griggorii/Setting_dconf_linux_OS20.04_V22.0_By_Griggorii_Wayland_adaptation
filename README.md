...
2020 Найден список пакетов которые тормозят запуск оболочки и его проводников и модулей какой из них точно не понятно , но вот ниже список по которому сначала лучше переустановить и заием сделать удаление.
