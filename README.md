...
$ chmod -R a+rwx Setting_dconf_linux_OS20.04_V43.0_By_Griggorii_Wayland_adaptation.sh

$ sudo ./Setting_dconf_linux_OS20.04_V43.0_By_Griggorii_Wayland_adaptation.sh
...
$ chmod -R a+rwx Replace_nemo-to-nautilus_dconf_linux_OS20.04_V43.0_By_Griggorii_Wayland_adaptation.sh

Not sudo run root system file replace 

$ sudo ./Replace_nemo-to-nautilus_dconf_linux_OS20.04_V43.0_By_Griggorii_Wayland_adaptation.sh
