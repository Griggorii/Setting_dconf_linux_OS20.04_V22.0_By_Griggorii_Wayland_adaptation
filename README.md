...
Спасти линукс можно тут http://chng.it/WDfJZLPgZZ причина очень проста некоторые думают чт о это за мусор на гит хаб и все такое как найти среди горы мусора линк на iso образ , а объяснение просто это не мусор это доказательство именно настоящей работы которую нельзя выбрасывать по причине первичности ибо потом не докажешь что разработан был данный linux дистрибутив именно всякими такими методами потому что один вид метода не подходит по причине что одним только подходом не разработать объектно ориентированный код позже над которым проведут обвязку и признают его онли уникальным , да мне самому не пристало держать кучу этого всего если бы корпорации мне не задушили инвестиции , а наоборот сосредоточились выявить точечными подходами что я действительно внес изменения в код и теперь meson может его дампнуть одним движением руки и выдать в мир новую операционную систему на основе этой разработки уже освобожденную от багов и тормозов ведь все придет к тому что я ранее и рассказывал очень быстрому qt4 или же авторов типа нового фраимворка заставят скопилефтить сгенерированные параметры в более новые версии и более точными цифрами что бы тормоза исчезли и версия прибавила циферку да это будет типа qt6 и выше тогда ux может и перстанет тормозит потому что будет наследование ускорения.
