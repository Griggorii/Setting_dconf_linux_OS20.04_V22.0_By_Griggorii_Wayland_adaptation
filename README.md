...
re-update nemo dconf 08.04.2021 dconf 21.04 recomend V46.0 fix nemo fractional scaling delete rm -rf icons nautilus root string fix | test Testing-setting-good-1-variant_and_2-variant?.zip perfomance location-mode='path-bar to location-mode='filename-entry'| 15.01.2021 fix [org/blueman/transfer] shared-path=''
