# Setting_dconf_linux_OS20.04_V41.0_By_Griggorii_Wayland_adaptation Nemo filemanger + sensor gdm3 touchpad
dconf , gnome , wayland , new os , package full os , V41.0 perfomance wayland , tango gedit , fast

re-update nemo dconf 04.03.2021 add V41.0 fractional scaling | test Testing-setting-good-1-variant_and_2-variant?.zip perfomance location-mode='path-bar to location-mode='filename-entry'| 15.01.2021 fix [org/blueman/transfer] shared-path=''
...
$ chmod -R a+rwx Setting_dconf_linux_OS20.04_V41.0_By_Griggorii_Wayland_adaptation.sh

$ sudo ./Setting_dconf_linux_OS20.04_V41.0_By_Griggorii_Wayland_adaptation.sh

Double repeat not sudo

$ ./Setting_dconf_linux_OS20.04_V41.0_By_Griggorii_Wayland_adaptation.sh
...
$ chmod -R a+rwx Replace_nemo-to-nautilus_dconf_linux_OS20.04_V41.0_By_Griggorii_Wayland_adaptation.sh

Not sudo run root system file replace 

$ sudo ./Replace_nemo-to-nautilus_dconf_linux_OS20.04_V41.0_By_Griggorii_Wayland_adaptation.sh

Double repeat not sudo

$ ./Replace_nemo-to-nautilus_dconf_linux_OS20.04_V41.0_By_Griggorii_Wayland_adaptation.sh
